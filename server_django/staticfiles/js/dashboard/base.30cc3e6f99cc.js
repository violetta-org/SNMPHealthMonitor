import{DataProcessor}from'../data-processor.js';export class BaseDashboardUI{constructor(dataProcessor){this.elements=new Map();this.dataProcessor=dataProcessor||new DataProcessor();this.lastUpdateTime=null;if(document.readyState==='loading'){document.addEventListener('DOMContentLoaded',()=>{setTimeout(()=>this.init(),0);});}else{setTimeout(()=>this.init(),0);}}
